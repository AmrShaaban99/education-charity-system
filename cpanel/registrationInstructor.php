...
$google_client=googleapi("registrationInstructor");
$login_button = '';
...
<body>
    <h1 class="titleOfPage">Registration</h1>
    <?php
	...
	<div class="page-content">
            <div class="form-v8-content">
                <div class="form-right">
                    <div class="tab">
                        <div class="tab-inner">
                                <button class="tablinks" onclick="openCity(event, 'instructor')" id="defaultOpen">Instructor</button>
                        </div>
                    </div>
                    <form class="form-detail" action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
                        <div class="tabcontent" id="instructor">
                            ...
                            <div class="form-row-last ">
                                    <a style="width: 100%;"href="<?php echo$google_client->createAuthUrl(); ?>" class="register connect-bottom">Google</a>
                            </div>
                            ...
                            <div class="form-row-last">
                                    ...
                                    <a class=""style="width: 100%;" href="RegistrationStudent.php">Student</a>
                            </div>
                        </div>
                    </form> 
